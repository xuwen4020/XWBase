#
#  Be sure to run `pod spec lint XWBase.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
	这是一个测试的说明,这是一个测试的说明,这是一个测试的说明,这是一个测试的说明,这是一个测试的说明
                   DESC
  ...
  # Or just: spec.author    = "xuwen"
  # spec.authors            = { "xuwen" => "996592197@qq.com" }
  # spec.social_media_url   = "https://twitter.com/xuwen"
